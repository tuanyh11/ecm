  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-200">
      ...
      <td className="px-6 py-4 font-semibold text-gray-900 dark:text-black">
        <div className="">
          <Link to={`/catalog/${item.product_id}`}>{`${item?.name}`}</Link>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <span
              type="number"
              id="first_product"
              className="bg-gray-50 text-center w-14 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-2.5 py-1 dark:bg-gray-400 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="1"
            >
              {quantity}
            </span>
